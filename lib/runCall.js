  ...
  function createEthereumConfig () {
    ...
    switch (hardfork) {
      case 'byzantium': {
        ...
        ethereumConfig.setConstantinopleblocknumber(new Uint8Array([108, 8, 65])) // 0x6C0841
        ethereumConfig.setPetersburgblocknumber(new Uint8Array([111, 21, 129]))   // 0x6F1581
        break
      }
      case 'constantinople': {
        ethereumConfig.setByzantiumblocknumber(new Uint8Array([0]))
